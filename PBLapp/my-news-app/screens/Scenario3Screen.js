...
const Scenario3Screen = () => {
  const scrollViewRef = useRef();

  const [open1, setOpen1] = useState(false);
  const [value1, setValue1] = useState(null);
  const [items1, setItems1] = useState([
    { label: "Tax Rebate", value: "tax_breaks" },
    { label: "Subsidy", value: "subsidies" },
    {label: "Export Credits", value: "export_credits"},
  ]);
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.title}>Incentive Type</Text>
        <View style={{ zIndex: open1 ? 1000 : 1 }}>
          <DropDownPicker
            open={open1}
            value={value1}
            items={items1}
        ...
        <Text style={styles.resultText}>Selected Type: {value1}</Text>
        ...
        <View style={{ zIndex: open2 ? 1000 : 1 }}>
          <DropDownPicker
            open={open2}
            value={value2}
            items={items2}
...
export default Scenario3Screen;
